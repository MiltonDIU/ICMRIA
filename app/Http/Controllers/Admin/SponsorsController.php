...
class SponsorsController extends Controller
{
    ...
    public function create()
    {
        ...
        $sponsorTypes = SponsorType::where('is_active','1')->pluck('title','id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.sponsors.create',compact('sponsorTypes'));
    }
    ...
    public function edit(Sponsor $sponsor)
    {
        ...
        $sponsorTypes = SponsorType::where('is_active','1')->pluck('title','id')->prepend(trans('global.pleaseSelect'), '');
        return view('admin.sponsors.edit', compact('sponsor','sponsorTypes'));
    }
