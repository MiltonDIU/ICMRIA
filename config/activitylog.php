...
return [
     ...
     *
     * 180 days covers the whole conference: submission opens September 2026 and the
     * proceedings close after the January 2027 event, so a question about who assigned
     * a reviewer or changed a decision can still be answered months afterwards.
     */
    'clean_after_days' => (int) env('ACTIVITYLOG_CLEAN_AFTER_DAYS', 180),
