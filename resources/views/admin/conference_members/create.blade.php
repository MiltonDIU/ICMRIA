...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.conference-members.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profile_url') ? 'is-invalid' : '' }}" type="text" name="profile_url" id="profile_url" value="{{ old('profile_url', '') }}">
