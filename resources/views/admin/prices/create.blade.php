            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('early_bird_price') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="early_bird_price" name="early_bird_price" class="form-control" value="{{ old('early_bird_price', '') }}" step="0.01" required>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('regular_price') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="regular_price" name="regular_price" class="form-control" value="{{ old('regular_price', '') }}" step="0.01" required>
