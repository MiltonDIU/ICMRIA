            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Sponsor">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.sponsor.fields.sponsor_type_id') }}
                        </th>
                        <th>
                            {{ trans('cruds.sponsor.fields.serial') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.sponsor.fields.amount') }}
                        </th>
                        <th>
                            {{ trans('cruds.sponsor.fields.note') }}
                        </th>
